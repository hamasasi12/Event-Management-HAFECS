                        ...
                        <div class="mt-6 p-5">
                            ...
                            <div class="flex gap-4 overflow-x-auto pb-2 -mx-1 px-1">
                                ...
                                @foreach ($attendees as $attendee)
                                    <div
                                        class="shrink-0 w-30 bg-gray-50/90 rounded-2xl border border-gray-100 px-3 py-4 text-center transition duration-300 shadow-sm hover:shadow-md">
        ...
        <div class="container mx-auto max-w-6xl flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2 grow sm:grow-0 sm:min-w-[200px]">
                ...
                <a href="{{ route('seminar.register', \Vinkla\Hashids\Facades\Hashids::encode($seminar->id)) }}"
                    class="w-full flex items-center justify-center gap-2 bg-gray-800 shadow-md text-white font-bold py-4 px-8 rounded-full transition-all">
                    Daftar Sekarang
                </a>
            </div>
        </div>
