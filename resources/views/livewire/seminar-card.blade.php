<div class="bg-white rounded-3xl p-8 shadow-xl card-hover border-t-4 border-coral ">
    ...
    <div class="text-center space-y-4">
        ...
        @if($seminar->status === 'upcoming')
            ...
            <a href="{{ route('seminar.show', $seminar->id) }}" class="bg-gradient-to-r from-coral to-red-500 text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300">
