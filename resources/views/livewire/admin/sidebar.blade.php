                ...
                <ul class="flex flex-col gap-2 mb-6">
                    ...
                    <li>
                        <a href="{{ route('admin.dashboard') }}" 
                           ...
                           {{ Request::routeIs('admin.dashboard') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-700 dark:text-gray-300 dark:hover:bg-blue-500/10 dark:hover:text-blue-400' }}"
                           wire:navigate>
                            
                            <!-- Active Page Indicator -->
                            <div x-show="page === 'dashboard'" 
                                 class="absolute left-0 top-0 h-full w-1.5 bg-white rounded-r-full"></div>
                            
                            <svg :class="page === 'dashboard' ? 'fill-white' : 'fill-gray-500 group-hover:fill-blue-600 dark:fill-gray-400 dark:group-hover:fill-blue-400'" 
                            ...
                            <div x-show="page === 'dashboard'" 
                                 class="absolute right-2 w-2 h-2 bg-white rounded-full animate-pulse"></div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('admin.seminar_registration.index') }}" 
                           ...
                           wire:navigate>
                            ...
                            <!-- Active Page Indicator -->
                            <div x-show="page === 'pendaftaran'" 
                                 class="absolute left-0 top-0 h-full w-1.5 bg-white rounded-r-full"></div>
                                 
                            <svg :class="page === 'pendaftaran' ? 'fill-white' : 'fill-gray-500 group-hover:fill-blue-600 dark:fill-gray-400 dark:group-hover:fill-blue-400'" 
                                 class="transition-all duration-300"
                                 width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="{{ route('admin.seminars.index') }}" 
                           class="group relative flex items-center gap-3 px-4 py-3 font-medium rounded-xl hover:bg-gray-200 text-sm transition-all duration-300 ease-in-out
                           {{ Request::routeIs('admin.seminars.index') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-700 dark:text-gray-300 dark:hover:bg-blue-500/10 dark:hover:text-blue-400' }}"
                           wire:navigate>
                            
                            <!-- Active Page Indicator -->
                            <div x-show="page === 'seminar'" 
                                 class="absolute left-0 top-0 h-full w-1.5 bg-white rounded-r-full"></div>
                                 
                            <svg :class="page === 'seminar' ? 'fill-white' : 'fill-gray-500 group-hover:fill-blue-600 dark:fill-gray-400 dark:group-hover:fill-blue-400'" 
                                 class="transition-all duration-300"
                                 width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
