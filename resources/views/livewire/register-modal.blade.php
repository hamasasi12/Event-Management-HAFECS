            ...
            <div class="px-8 py-10 relative z-10 bg-white">
                ...
                <form action="{{ route('register') }}" method="POST" class="mt-6 space-y-4 relative z-10">
                    ...
                    <div x-data="{ showConfirmPassword: false }" class="relative">
                        ...
                        <input id="password_confirmation" name="password_confirmation" x-bind:type="showConfirmPassword ? 'text' : 'password'" required
                            class="appearance-none block w-full px-4 py-3 pr-11 border border-gray-300 placeholder-gray-400 text-gray-900 rounded-xl focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-gray-50 transition-colors"
                            placeholder="Confirm Password">
                        <button type="button" @click="showConfirmPassword = !showConfirmPassword" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-gray-600 focus:outline-none transition-colors">
