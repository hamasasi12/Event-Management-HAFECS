    ...
    <div class="min-h-screen hero-bg relative overflow-hidden">
        ...
        <header class="relative z-10 p-6">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <a href="{{ url('/') }}" class="text-white hover:text-teal transition-colors px-4 py-2 rounded-full hover:bg-white hover:bg-opacity-10">
                    ← Kembali ke Home
                </a>
            </div>
        </header>
                    ...
                    <div id="loginForm" class="auth-card rounded-3xl p-8 shadow-2xl slide-in">
                        ...
                        <div class="relative mb-6">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="px-2 bg-white text-gray-500">admin</span>
                            </div>
                        </div>
