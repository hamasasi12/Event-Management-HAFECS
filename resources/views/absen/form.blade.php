                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="jabatan" id="jabatan" required
                                ...
                                <option value="pengawas" {{ old('jabatan') == 'pengawas' ? 'selected' : '' }}>Pengawas
                                </option>
                        ...
                        {{-- <div>
                            ...
                            <input type="text" name="kota_kabupaten" id="kota_kabupaten"
                                value="{{ old('kota_kabupaten') }}" placeholder="Masukkan kota/kabupaten" required
                        ...
                        {{-- <div>
                            ...
                            <select name="provinsi" id="provinsi" required
                                ...
                                <option value="sumatera_utara"
                                    {{ old('provinsi') == 'sumatera_utara' ? 'selected' : '' }}>Sumatera Utara</option>
                                <option value="sumatera_barat"
                                    {{ old('provinsi') == 'sumatera_barat' ? 'selected' : '' }}>Sumatera Barat</option>
                                <option value="riau" {{ old('provinsi') == 'riau' ? 'selected' : '' }}>Riau</option>
                                <option value="jambi" {{ old('provinsi') == 'jambi' ? 'selected' : '' }}>Jambi
                                </option>
                                <option value="sumatera_selatan"
                                    {{ old('provinsi') == 'sumatera_selatan' ? 'selected' : '' }}>Sumatera Selatan
                                </option>
                                <option value="bengkulu" {{ old('provinsi') == 'bengkulu' ? 'selected' : '' }}>
                                    Bengkulu</option>
                                <option value="lampung" {{ old('provinsi') == 'lampung' ? 'selected' : '' }}>Lampung
                                </option>
                                <option value="kepulauan_bangka_belitung"
                                    {{ old('provinsi') == 'kepulauan_bangka_belitung' ? 'selected' : '' }}>Kepulauan
                                    Bangka Belitung</option>
                                <option value="kepulauan_riau"
                                    {{ old('provinsi') == 'kepulauan_riau' ? 'selected' : '' }}>Kepulauan Riau</option>
                                <option value="dki_jakarta" {{ old('provinsi') == 'dki_jakarta' ? 'selected' : '' }}>
                                    DKI Jakarta</option>
                                <option value="jawa_barat" {{ old('provinsi') == 'jawa_barat' ? 'selected' : '' }}>
                                    Jawa Barat</option>
                                <option value="jawa_tengah" {{ old('provinsi') == 'jawa_tengah' ? 'selected' : '' }}>
                                    Jawa Tengah</option>
                                <option value="di_yogyakarta"
                                    {{ old('provinsi') == 'di_yogyakarta' ? 'selected' : '' }}>DI Yogyakarta</option>
                                <option value="jawa_timur" {{ old('provinsi') == 'jawa_timur' ? 'selected' : '' }}>
                                    Jawa Timur</option>
                                <option value="banten" {{ old('provinsi') == 'banten' ? 'selected' : '' }}>Banten
                                </option>
                                <option value="bali" {{ old('provinsi') == 'bali' ? 'selected' : '' }}>Bali</option>
                                <option value="nusa_tenggara_barat"
                                    {{ old('provinsi') == 'nusa_tenggara_barat' ? 'selected' : '' }}>Nusa Tenggara
                                    Barat</option>
                                <option value="nusa_tenggara_timur"
                                    {{ old('provinsi') == 'nusa_tenggara_timur' ? 'selected' : '' }}>Nusa Tenggara
                                    Timur</option>
                                <option value="kalimantan_barat"
                                    {{ old('provinsi') == 'kalimantan_barat' ? 'selected' : '' }}>Kalimantan Barat
                                </option>
                                <option value="kalimantan_tengah"
                                    {{ old('provinsi') == 'kalimantan_tengah' ? 'selected' : '' }}>Kalimantan Tengah
                                </option>
                                <option value="kalimantan_selatan"
                                    {{ old('provinsi') == 'kalimantan_selatan' ? 'selected' : '' }}>Kalimantan Selatan
                                </option>
                                <option value="kalimantan_timur"
                                    {{ old('provinsi') == 'kalimantan_timur' ? 'selected' : '' }}>Kalimantan Timur
                                </option>
                                <option value="kalimantan_utara"
                                    {{ old('provinsi') == 'kalimantan_utara' ? 'selected' : '' }}>Kalimantan Utara
                                </option>
                                <option value="sulawesi_utara"
                                    {{ old('provinsi') == 'sulawesi_utara' ? 'selected' : '' }}>Sulawesi Utara</option>
                                <option value="sulawesi_tengah"
                                    {{ old('provinsi') == 'sulawesi_tengah' ? 'selected' : '' }}>Sulawesi Tengah
                                </option>
                                <option value="sulawesi_selatan"
                                    {{ old('provinsi') == 'sulawesi_selatan' ? 'selected' : '' }}>Sulawesi Selatan
                                </option>
                                <option value="sulawesi_tenggara"
                                    {{ old('provinsi') == 'sulawesi_tenggara' ? 'selected' : '' }}>Sulawesi Tenggara
                                </option>
                                <option value="gorontalo" {{ old('provinsi') == 'gorontalo' ? 'selected' : '' }}>
                                    Gorontalo</option>
                                <option value="sulawesi_barat"
                                    {{ old('provinsi') == 'sulawesi_barat' ? 'selected' : '' }}>Sulawesi Barat</option>
                                <option value="maluku" {{ old('provinsi') == 'maluku' ? 'selected' : '' }}>Maluku
                                </option>
                                <option value="maluku_utara"
                                    {{ old('provinsi') == 'maluku_utara' ? 'selected' : '' }}>Maluku Utara</option>
                                <option value="papua_barat" {{ old('provinsi') == 'papua_barat' ? 'selected' : '' }}>
                                    Papua Barat</option>
                                <option value="papua" {{ old('provinsi') == 'papua' ? 'selected' : '' }}>Papua
                                </option>
                            </select>
                            @error('provinsi')
                                <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#province').change(function() {
                ...
                regencySelect.empty().append('<option value="">Pilih Kabupaten</option>');

                if (provinceName) {
                    addLoadingState(regencySelect);

                    // Encode URL untuk handle spasi dan karakter khusus
                    $.ajax({
                        url: '/regencies/' + encodeURIComponent(provinceName),
                        type: 'GET',
                        dataType: 'json',
                        success: function(data) {
                            console.log('Regencies data:', data); // Debug
                            ...
                            removeLoadingState(regencySelect);
                        },
            ...
            @if (old('provinsi'))
                $('#province').val('{{ old('provinsi') }}').trigger('change');

                @if (old('kabupaten'))
                    setTimeout(function() {
                        $('#regency').val('{{ old('kabupaten') }}');
                    }, 500);
                @endif
            @endif
        });
