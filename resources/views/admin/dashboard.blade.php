...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div class="rounded-sm border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="bg-gray-50 px-4 py-3 text-right sm:px-6 dark:bg-gray-700">
            <a href="{{ route('admin.seminar_registration.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 dark:bg-gray-600 dark:text-white dark:border-gray-600">
                View all users
            </a>
        </div>
    </div>
